// Icon.jsx — inline SVG icons, no icon-font / CDN dependency.
// Usage: <Icon name="users" size={16} />
const P = {
  ...
  "mail-off": <><rect x="2" y="4" width="20" height="16" rx="2"/><line x1="2" y1="2" x2="22" y2="22"/></>,
  plug: <><path d="M9 2v6M15 2v6"/><path d="M6 8h12v3a6 6 0 0 1-12 0z"/><path d="M12 17v5"/></>,
  sparkles: <><path d="M12 3l1.8 4.2L18 9l-4.2 1.8L12 15l-1.8-4.2L6 9l4.2-1.8z"/><path d="M18.5 15l.9 2.1 2.1.9-2.1.9-.9 2.1-.9-2.1-2.1-.9 2.1-.9z"/></>,
  shield: <><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><circle cx="12" cy="11" r="2"/><path d="M12 13v3"/></>,
  alert: <><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></>,
  pencil: <path d="M17 3a2.83 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5z"/>,
  "chevron-down": <polyline points="6 9 12 15 18 9"/>,
  "chevron-right": <polyline points="9 18 15 12 9 6"/>,
  dots: <><circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="19" cy="12" r="1.6" fill="currentColor" stroke="none"/><circle cx="5" cy="12" r="1.6" fill="currentColor" stroke="none"/></>,
  ...
  brain: <><path d="M9.5 3A2.5 2.5 0 0 0 7 5.5v.5a2.5 2.5 0 0 0-1 4.77V13a3 3 0 0 0 3 3h2V3z"/><path d="M14.5 3A2.5 2.5 0 0 1 17 5.5v.5a2.5 2.5 0 0 1 1 4.77V13a3 3 0 0 1-3 3h-2V3z"/><path d="M12 16v5"/></>,
...
export default function Icon({ name, size = 16, className = "", style = {} }) {
  ...
  if (!path) return null;
  return (
    <svg viewBox="0 0 24 24" className={`dn-icon ${className}`} style={{ fontSize: size, ...style }} aria-hidden="true">
      {path}
    </svg>
  );
}
