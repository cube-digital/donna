// Icon.tsx — inline SVG icons, no icon-font / CDN dependency.
// Ported verbatim from assets/donna-ui-kit/react/Icon.jsx.
...
const P: Record<string, ReactNode> = {
  ...
  brain: (
    <>
      <path d="M9.5 3A2.5 2.5 0 0 0 7 5.5v.5a2.5 2.5 0 0 0-1 4.77V13a3 3 0 0 0 3 3h2V3z" />
      <path d="M14.5 3A2.5 2.5 0 0 1 17 5.5v.5a2.5 2.5 0 0 1 1 4.77V13a3 3 0 0 1-3 3h-2V3z" />
      <path d="M12 16v5" />
    </>
  ),
  x: (
